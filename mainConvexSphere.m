...
discontDetectionPara.numOfDiscont         = 3;            % number of discontinuities per transient
...
pathSurfaceDerivativePara.curvatureRatioThreshold  = 8e-2;           % reconstruction threshold, smaller the value, looser the constraint
